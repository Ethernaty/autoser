...
class Settings(BaseSettings):
    ...
    enable_deferred_platform_runtime: bool = Field(default=False, alias="ENABLE_DEFERRED_PLATFORM_RUNTIME")
    enable_presentation_runtime: bool = Field(default=False, alias="ENABLE_PRESENTATION_RUNTIME")
